...
export const LOG_DATASET_PREP = "[DATA] Preparing dataset...";
export const LOG_TRAINING_START = "[TRAIN] Starting training (kohya_ss)...";
export const ENV_LOG_PREFIX = "ED LoRA dir: ";
export const ENV_NOT_READY_MESSAGE = "Environment is not ready";
export const ERROR_NAME_REQUIRED = "Character name (ID) is required";
export const ERROR_MIN_IMAGES = "At least 8 reference images required";
